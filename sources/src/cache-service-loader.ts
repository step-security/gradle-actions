...
const ENHANCED_CACHE_MESSAGE = `Enhanced Caching: This build is using the proprietary 'gradle-actions-caching' provider for optimized caching support. See https://github.com/step-security/gradle-actions/blob/main/DISTRIBUTION.md for terms of use and opt-out instructions.`
...
> See [DISTRIBUTION.md](https://github.com/step-security/gradle-actions/blob/main/DISTRIBUTION.md) for details.`
