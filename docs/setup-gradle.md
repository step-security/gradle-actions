...
with `step-security/gradle-actions/wrapper-validation`.
...
> using `step-security/gradle-actions/dependency-submission`. This action will attempt to detect all dependencies used by your build
