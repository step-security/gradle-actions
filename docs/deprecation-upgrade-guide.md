...
the https://github.com/gradle/actions repository, and the `gradle/wrapper-validation-action` has been replaced by the `step-security/gradle-actions/wrapper-validation` action.
...
development and releases will continue in the `step-security/gradle-actions/wrapper-validation` action.
...
- name: Assemble the project
  uses: step-security/gradle-actions/setup-gradle@v3
  with:
    arguments: 'assemble'
